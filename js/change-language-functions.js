var languageContent = {
    greek: {
      languageBtn: "EL",
      mainTitle: "Αναγγελία Άσκησης Επαγγέλματος Φυσικοθεραπευτή",
      pageTitle: "Αναγγελία Άσκησης Επαγγέλματος Φυσικοθεραπευτή",
      infoTitle: "Πληροφορίες για την αναγγελία άσκησης επαγγέλματος φυσικοθεραπευτή",
      subTitle1: "Αυτό το ερωτηματολόγιο μπορεί να σας βοηθήσει να ελέγξετε αν πληροίτε τις βασικές προϋποθέσεις για την αναγγελία άσκησης επαγγέλματος φυσικοθεραπευτή.",
    ...
    english: {
      languageBtn: "EN",
      mainTitle: "Notification of Practicing the Profession of Physiotherapist",
      pageTitle: "Notification of Practicing the Profession of Physiotherapist",
      infoTitle: "Information on the notification of practicing the profession of physiotherapist",
      subTitle1: "This questionnaire can help you check whether you meet the basic requirements for the notification of practicing the profession of physiotherapist.",
